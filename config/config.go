...
func DefaultKeyMap(args ...string) wig.ModeKeyMap {
	...
	return wig.ModeKeyMap{
		wig.MODE_NORMAL: wig.KeyMap{
			...
			"F12":    ui.CmdMiniHelp,
			"ctrl+d": wig.CmdMultiCursorMatchNext,
			"ctrl+k": wig.CmdMultiCursorSkipNext,
			")":      wig.CmdMultiCursorRotateForward,
			"(":      wig.CmdMultiCursorRotateBackward,
			...
			"A":      wig.CmdAppendEndOfLines,
			"C":      wig.CmdMultiCursorAddDown,
